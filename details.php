                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="about-right mb-90">
                                ...
                                <div class="section-tittle mb-30 pt-30">
                                    <h3>Malalang problema ng mga OFW</h3>
                                </div>
                                <div class="about-prea">
                                    
                                    <p class="about-pera1 mb-25">
                                       Sabi ng batas, ang DMW ay dapat 24/7 na nakatutok sa mga "emergency needs" ng OFW at ng kanilang mga pamilya.
                                        ...
                                        Paano yan, mag-email ka sa POLO (MWO) hindi sila nagrereply. Labag na pala ito sa bagong batas. HINDI LANG BASTA "CALL CENTER" KUNDI "ACTION CENTER" TALAGA ANG MANDATO NG BATAS. Dahil may budget para dito at sa mga tao na kung tawagin ay "Emergency Responders". May pagkakaiba po kasi ang "taga sagot ng tawag" sa "taga responde".

                                        Katotohanan po ito. Wala talaga tayong mababasa sa kahit saang batas na ang recruitment agencies ay siyang inu-obliga na magmonitor sa worker 24/7. Pero mga recruitment agencies ang gustong gawing CCTV ng ilan kahit alam naman nila sa sarili na imposible talagang magawa ito sa totoong buhay.

                                        PANOORIN SA LIVE KO (April 8, 2023) ANG DETALYE NG MGA BATAS.

                                        https://fb.watch/jSjXaksJUJ/?mibextid=RUbZ1f</p>
                                </div> 
                        ...
                        <div class="col-lg-6">
                            <div class="footer-copy-right">
                                <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                                  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved |   by <a href="https://yaramay.com" target="_blank">Yaramay</a>
                                  </p>
                            </div>
                        </div>
                        <div class="col-lg-6">
